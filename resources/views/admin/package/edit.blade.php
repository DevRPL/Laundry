...
@section('breadcrumb')
    <span class="kt-subheader__breadcrumbs-separator"></span>
        <a href="{{ route('master.pakets.edit', $package->id) }}" class="kt-subheader__breadcrumbs-link">
            Edit Paket Laundry                  
        </a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
    ...
    <div class="row">
        <div class="col-lg-12">	
            <div class="kt-portlet__body">
                <form class="kt-form" method="POST" action="{{ route('master.pakets.update', $package->id ) }}">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    <label class="col-3 col-form-label">Harga/Kg*:</label>
                                    <div class="col-9">
